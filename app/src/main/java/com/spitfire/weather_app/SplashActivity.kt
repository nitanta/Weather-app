...
import com.spitfire.weather_app.databinding.ActivitySplashBinding
...
class SplashActivity : AppCompatActivity() {
    ...
    override fun onResume() {
        ...
        var animCloud = AnimationUtils.loadAnimation(this, R.anim.anim_splash_cloud)
        var animSun = AnimationUtils.loadAnimation(this, R.anim.anim_splash_sum)
