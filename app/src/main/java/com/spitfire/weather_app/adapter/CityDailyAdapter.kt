...
import com.spitfire.weather_app.databinding.ForcastWeatherDailyItemBinding

class CityDailyAdapter(val cityDailyList: ArrayList<CityDailyResponse.Forecast>): RecyclerView.Adapter<CityDailyAdapter.CityDailyViewHolder>() {

    class CityDailyViewHolder(var view: ForcastWeatherDailyItemBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CityDailyViewHolder {
        ...
        val view = DataBindingUtil.inflate<ForcastWeatherDailyItemBinding>(
            inflater,
            R.layout.forcast_weather_daily_item,
            parent,
            false
        )
